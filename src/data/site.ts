...
export const employees: Employee[] = [
  ...
  { id:'EMP-15', name:'Quế Anh', slug:'que-anh', role:'Voice AI Automation', department:'Sales Automation', bio:'Quế Anh đại diện gói Voice AI: nghe máy, hỏi nhu cầu, ghi transcript và đẩy CRM.', missions:['Nghe cuộc gọi.', 'Hỏi nhu cầu khách.', 'Đẩy dữ liệu sang transcript/CRM.'], kpis:['Calls','Transcript','Qualified Lead'], workflowIds:['WF31','WF31A','WF31D'], systemIds:['G3','G6'], media:[{type:'video',title:'Quế Anh Voice AI Demo',url:'/media/videos/que-anh-voice-ai-demo.mp4',caption:'Video: Tôi là Quế Anh, tôi có thể nghe máy 24/7 cho đội sales.'}] },
  ...
  { id:'EMP-19', name:'Vân Anh', slug:'van-anh', role:'Dashboard Automation', department:'Dashboard & Intelligence', bio:'Vân Anh đại diện gói Dashboard AI: theo dõi toàn bộ hệ thống Huy Automation AI.', missions:['Theo dõi dashboard.', 'Cảnh báo workflow lỗi.', 'Báo cáo chỉ số cho founder/CEO.'], kpis:['Dashboard','Alert','Report'], workflowIds:['WF08','WF09'], systemIds:['G5'], media:[{type:'video',title:'Vân Anh Dashboard Demo',url:'/media/videos/van-anh-dashboard-demo.mp4',caption:'Video: Tôi là Vân Anh, tôi theo dõi dashboard của hệ thống Huy Automation AI.'}] },
];
...
export const workflows: Workflow[] = [
  ...
  wf('WF23','wf23','Execution Manager','Active','Route task và theo dõi tiến độ.', 'Giang Anh giúp việc không bị rơi giữa các workflow.', 'Task queue','Assigned tasks',['n8n','Telegram','Sheets'],['giang-anh'],['G4']),
...
function wf(id:string, slug:string, name:string, status:string, shortDescription:string, purpose:string, input:string, output:string, tools:string[], employeeSlugs:string[], systemIds:string[], videoUrl = ''): Workflow {
  return { id, slug, name, status, shortDescription, purpose, input, output, tools, employeeSlugs, systemIds, lessons: ['Workflow phải có input/output rõ ràng.', 'Tên AI giúp khách nhớ sản phẩm dễ hơn mã workflow.'], imageUrl: `/media/workflows/${slug}.png`, videoUrl, offer: { title: `Sở hữu ${name}`, includes: ['Workflow setup', 'Data structure', 'Demo handover', 'Training sử dụng'], cta: 'Đặt lịch demo' } };
}
...
export const caseStudies: CaseStudy[] = [
  ...
  { slug:'ai-company-os', title:'AI Company OS', summary:'Từ studio ảnh gia đình đến đội ngũ 19 AI Employees.', problem:'Chủ doanh nghiệp nhỏ phải tự xử lý quá nhiều việc.', solution:'Nhân cách hóa workflow thành 19 AI Employees để dễ hiểu, dễ nhớ, dễ bán.', result:'Tạo khung Sales Hub nơi mỗi AI tự bán workflow phía sau.', relatedWorkflows:['WF00','WF09','WF31','WF14'], relatedSystems:['G1','G3','G5','G6'] },
];
...
export const blogPosts: BlogPost[] = [
  ...
  { slug:'19-ai-employees-khong-phai-chatbot', title:'19 AI Employees không phải chatbot', excerpt:'Mỗi AI là một workflow, một sản phẩm và một nhân vật bán hàng.', category:'AI Workforce', body:['Quế Anh không chỉ là một cái tên.', 'Quế Anh là Voice AI Automation phía sau WF31.', 'Khi khách nhớ nhân vật, họ dễ hiểu sản phẩm hơn.'] },
...
export const dataGuide = {
  text: 'Sửa nội dung trong src/data/site.ts. Đây là nơi quản lý departments, employees, workflows, systems, case studies và blog.',
  ...
  lead: 'Mọi CTA “Sở hữu AI này”, “Đặt demo”, “Nhận tư vấn” đang dẫn về /consultation để thu lead.',
};
